...
export function AdminPage() {
    ...
    async function setAdminRole(dateToAdmin) {
        const token = await authService.getAccessToken();
        dateToAdmin = JSON.stringify(dateToAdmin);
    ...
    async function setUserRole(dateToUser) {
        const token = await authService.getAccessToken();
        dateToUser = JSON.stringify(dateToUser);
